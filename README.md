...
**Status:** pre-alpha, private use. The pure-JVM core is built and tested. The Android app is
written against framework APIs and type-checked, and has not yet been run on a phone.
