...
**Status:** pre-alpha, private use. The pure-JVM core is built and tested (254 tests). The
Android app is written against framework APIs and type-checked, and has not yet been run on a
phone. Head of work is `grok/m1-closeout` (reality check + the review fixes in TM-010–013).
