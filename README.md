...
**Status:** pre-alpha, private use. Head of work is `grok/m1-closeout` (TM-010–029).
...
M4 v1 (on-device Talk, QS/notification/shortcut Talk), M6 v1 (`screen ask` JPEG to the brain),
and TM-028 (whole-job verbs first; Jerry resolves through Contacts).
